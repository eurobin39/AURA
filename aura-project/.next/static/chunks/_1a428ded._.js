(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_1a428ded._.js", {
...
const Button = ({ children, onClick, variant = "primary", className = "" })=>{
    const baseStyles = "px-6 py-3 text-lg font-semibold rounded-full shadow-md transition-all duration-300 transform focus:ring-4 focus:outline-none";
    const variants = {
        primary: "bg-blue-600 text-white hover:bg-blue-700 hover:scale-105 active:scale-95",
        secondary: "bg-green-500 text-white hover:bg-green-600 hover:scale-105 active:scale-95",
        outline: "border border-white text-white hover:bg-white hover:text-gray-900 hover:scale-105 active:scale-95",
        glass: "bg-white bg-opacity-10 text-white border border-white border-opacity-30 backdrop-blur-lg hover:bg-opacity-20 hover:scale-105 active:scale-95"
    };
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/button.tsx [app-client] (ecmascript)"); // ✅ 버튼 컴포넌트 사용
"use client";
;
;
;
...
//# sourceMappingURL=_1a428ded._.js.map